...
This is a starter-theme for WordPress based on FoundationPress which is based on Foundation 6, the most advanced responsive (mobile-first) framework in the world. The purpose of DrumRoll, is to act as a small and handy toolbox that contains the essentials needed to build any design. DrumRoll is meant to be a starting point, not the final product.
...
$ git clone https://github.com/joelnewcomer/drum-roll.git
$ cd drum-roll
$ npm install
```
...
* [Kessick Wine Cellars](http://www.kessickwinecellars.com/)


>Credit goes to all the brilliant designers and developers out there. Have **you** made a site that should be on this list? [Please let me know](https://twitter.com/joelnewcomer)
